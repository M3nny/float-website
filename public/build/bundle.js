...
var app = (function () {
    ...
    // (28:2) <Typewriter interval={150} cursor={false}>
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(28:2) <Typewriter interval={150} cursor={false}>",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img0, file, 23, 2, 410);
    			...
    			add_location(img1, file, 24, 2, 496);
    			...
    			add_location(img2, file, 25, 2, 610);
    			add_location(section, file, 22, 1, 398);
    			if (!src_url_equal(img3.src, img3_src_value = "images/bot_icon.png")) attr_dev(img3, "src", img3_src_value);
    			attr_dev(img3, "alt", "bi");
    			attr_dev(img3, "class", "object-contain h-48 w-96");
    			add_location(img3, file, 34, 3, 874);
    			attr_dev(h1, "class", "text-center");
    			set_style(h1, "font-size", "50px");
    			add_location(h1, file, 37, 2, 961);
    			attr_dev(h2, "class", "text-center");
    			set_style(h2, "font-size", "35px");
    			add_location(h2, file, 38, 2, 1019);
    			add_location(div0, file, 35, 2, 952);
    			add_location(div1, file, 33, 2, 865);
    			attr_dev(div2, "class", "font-9xl flex flex-wrap justify-center my-8");
    			add_location(div2, file, 32, 1, 805);
    			add_location(main, file, 21, 0, 390);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
