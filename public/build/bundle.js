...
var app = (function () {
    ...
    // (40:3) <Typewriter interval={150} cursor={false}>
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "id", "text");
    			add_location(h2, file, 40, 4, 1234);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(40:3) <Typewriter interval={150} cursor={false}>",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			br2 = element("br");
    			t16 = text(" providing a faster experience.");
    			t17 = space();
    			div3 = element("div");
    			t18 = space();
    			div4 = element("div");
    			...
    			add_location(path1, file, 66, 8, 2407);
    			attr_dev(svg1, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg1, "class", "h-6 w-6");
    			attr_dev(svg1, "fill", "none");
    			attr_dev(svg1, "viewBox", "0 0 24 24");
    			attr_dev(svg1, "stroke", "gray");
    			add_location(svg1, file, 65, 7, 2296);
    			attr_dev(p2, "class", "text-xl text-cyan-600");
    			add_location(p2, file, 68, 7, 2600);
    			add_location(br1, file, 69, 68, 2714);
    			attr_dev(p3, "class", "text-slate-50");
    			add_location(p3, file, 69, 7, 2653);
    			add_location(div1, file, 64, 6, 2239);
    			...
    			add_location(path2, file, 74, 8, 2954);
    			attr_dev(svg2, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg2, "class", "h-6 w-6");
    			attr_dev(svg2, "fill", "none");
    			attr_dev(svg2, "viewBox", "0 0 24 24");
    			attr_dev(svg2, "stroke", "gray");
    			add_location(svg2, file, 73, 7, 2843);
    			attr_dev(p4, "class", "text-xl text-cyan-600");
    			add_location(p4, file, 76, 7, 3200);
    			add_location(br2, file, 77, 67, 3338);
    			attr_dev(p5, "class", "text-slate-50");
    			add_location(p5, file, 77, 7, 3278);
    			add_location(div2, file, 72, 6, 2786);
    			add_location(div3, file, 80, 6, 3398);
    			...
    			add_location(path3, file, 84, 8, 3591);
    			attr_dev(svg3, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg3, "class", "h-6 w-6");
    			attr_dev(svg3, "fill", "none");
    			attr_dev(svg3, "viewBox", "0 0 24 24");
    			attr_dev(svg3, "stroke", "gray");
    			add_location(svg3, file, 83, 7, 3480);
    			attr_dev(p6, "class", "text-xl text-cyan-600");
    			add_location(p6, file, 86, 7, 3794);
    			add_location(br3, file, 87, 54, 3900);
    			attr_dev(p7, "class", "text-slate-50");
    			add_location(p7, file, 87, 7, 3853);
    			add_location(div4, file, 82, 6, 3417);
    			attr_dev(div5, "class", "h-56 grid grid-cols-3 gap-4 content-center my-10");
    			add_location(div5, file, 54, 5, 1690);
    			if (!src_url_equal(img0.src, img0_src_value = "images/discord_logo.png")) attr_dev(img0, "src", img0_src_value);
    			attr_dev(img0, "alt", "dl");
    			attr_dev(img0, "class", "mx-auto object-contain h-10 w-9");
    			add_location(img0, file, 95, 9, 4302);
    			attr_dev(div6, "class", "mx-5");
    			add_location(div6, file, 96, 9, 4399);
    			attr_dev(div7, "class", "flex items-center");
    			add_location(div7, file, 94, 8, 4261);
    			attr_dev(button0, "class", "bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded");
    			add_location(button0, file, 93, 7, 4088);
    			attr_dev(div8, "class", "flex flex-wrap justify-center");
    			add_location(div8, file, 92, 6, 4037);
    			if (!src_url_equal(img1.src, img1_src_value = "images/github_logo.png")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "gl");
    			attr_dev(img1, "class", "mx-auto object-contain h-10 w-9");
    			add_location(img1, file, 103, 9, 4749);
    			attr_dev(div9, "class", "mx-5");
    			add_location(div9, file, 104, 9, 4845);
    			attr_dev(div10, "class", "flex items-center");
    			add_location(div10, file, 102, 8, 4708);
    			attr_dev(button1, "class", "bg-stone-400 hover:bg-stone-300 text-white font-bold py-2 px-4 border-b-4 border-stone-600 hover:border-stone-400 rounded");
    			add_location(button1, file, 101, 7, 4532);
    			attr_dev(div11, "class", "flex flex-wrap justify-center");
    			add_location(div11, file, 100, 6, 4481);
    			attr_dev(div12, "class", "h-56 grid grid-cols-2 gap-1 content-center my-10");
    			add_location(div12, file, 91, 5, 3968);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(button0, "click", handleClickDiscord, false, false, false),
    					listen_dev(button1, "click", handleClickGithub, false, false, false)
    				];
    ...
    // (34:1) <Visibility steps={100} let:percent let:unobserve let:intersectionObserverSupport>
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img0, file, 35, 3, 909);
    			...
    			add_location(img1, file, 36, 3, 996);
    			...
    			add_location(img2, file, 37, 3, 1111);
    			add_location(section, file, 34, 2, 896);
    			...
    			add_location(img3, file, 46, 4, 1382);
    			attr_dev(h1, "class", "text-center");
    			set_style(h1, "font-size", "50px");
    			add_location(h1, file, 48, 5, 1504);
    			attr_dev(h2, "class", "text-center");
    			set_style(h2, "font-size", "35px");
    			add_location(h2, file, 49, 5, 1569);
    			attr_dev(div0, "class", "text-cyan-700");
    			add_location(div0, file, 47, 4, 1471);
    			add_location(div1, file, 45, 3, 1372);
    			attr_dev(div2, "class", "font-9xl flex flex-wrap justify-center my-8");
    			add_location(div2, file, 44, 2, 1311);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(34:1) <Visibility steps={100} let:percent let:unobserve let:intersectionObserverSupport>",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 32, 0, 803);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
