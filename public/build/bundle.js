...
var app = (function () {
    ...
    // (36:3) <Typewriter interval={150} cursor={false}>
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "id", "text");
    			add_location(h2, file, 36, 4, 1121);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(36:3) <Typewriter interval={150} cursor={false}>",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path0, file, 54, 8, 1822);
    			attr_dev(svg0, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg0, "class", "h-6 w-6");
    			attr_dev(svg0, "fill", "none");
    			attr_dev(svg0, "viewBox", "0 0 24 24");
    			attr_dev(svg0, "stroke", "gray");
    			add_location(svg0, file, 53, 7, 1711);
    			attr_dev(p0, "class", "text-xl text-cyan-600");
    			add_location(p0, file, 56, 7, 1966);
    			add_location(br0, file, 57, 52, 2071);
    			attr_dev(p1, "class", "text-slate-50");
    			add_location(p1, file, 57, 7, 2026);
    			add_location(div0, file, 52, 6, 1653);
    			...
    			add_location(path1, file, 62, 8, 2294);
    			attr_dev(svg1, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg1, "class", "h-6 w-6");
    			attr_dev(svg1, "fill", "none");
    			attr_dev(svg1, "viewBox", "0 0 24 24");
    			attr_dev(svg1, "stroke", "gray");
    			add_location(svg1, file, 61, 7, 2183);
    			attr_dev(p2, "class", "text-xl text-cyan-600");
    			add_location(p2, file, 64, 7, 2487);
    			add_location(br1, file, 65, 68, 2601);
    			attr_dev(p3, "class", "text-slate-50");
    			add_location(p3, file, 65, 7, 2540);
    			add_location(div1, file, 60, 6, 2126);
    			...
    			add_location(path2, file, 70, 8, 2841);
    			attr_dev(svg2, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg2, "class", "h-6 w-6");
    			attr_dev(svg2, "fill", "none");
    			attr_dev(svg2, "viewBox", "0 0 24 24");
    			attr_dev(svg2, "stroke", "gray");
    			add_location(svg2, file, 69, 7, 2730);
    			attr_dev(p4, "class", "text-xl text-cyan-600");
    			add_location(p4, file, 72, 7, 3087);
    			add_location(br2, file, 73, 67, 3225);
    			attr_dev(p5, "class", "text-slate-50");
    			add_location(p5, file, 73, 7, 3165);
    			add_location(div2, file, 68, 6, 2673);
    			add_location(div3, file, 76, 6, 3285);
    			...
    			add_location(path3, file, 80, 8, 3478);
    			attr_dev(svg3, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg3, "class", "h-6 w-6");
    			attr_dev(svg3, "fill", "none");
    			attr_dev(svg3, "viewBox", "0 0 24 24");
    			attr_dev(svg3, "stroke", "gray");
    			add_location(svg3, file, 79, 7, 3367);
    			attr_dev(p6, "class", "text-xl text-cyan-600");
    			add_location(p6, file, 82, 7, 3681);
    			add_location(br3, file, 83, 54, 3787);
    			attr_dev(p7, "class", "text-slate-50");
    			add_location(p7, file, 83, 7, 3740);
    			add_location(div4, file, 78, 6, 3304);
    			attr_dev(div5, "class", "h-56 grid grid-cols-3 gap-4 content-center my-10");
    			add_location(div5, file, 50, 5, 1577);
    			...
    			add_location(img, file, 89, 8, 4115);
    			attr_dev(div6, "class", "mx-5");
    			add_location(div6, file, 90, 8, 4212);
    			attr_dev(div7, "class", "flex items-center");
    			add_location(div7, file, 88, 7, 4075);
    			...
    			add_location(button, file, 87, 6, 3910);
    			attr_dev(div8, "class", "flex flex-wrap justify-center my-20");
    			add_location(div8, file, 86, 5, 3854);
    		},
    		m: function mount(target, anchor) {
    ...
    // (30:1) <Visibility steps={100} let:percent let:unobserve let:intersectionObserverSupport>
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img0, file, 31, 3, 796);
    			...
    			add_location(img1, file, 32, 3, 883);
    			...
    			add_location(img2, file, 33, 3, 998);
    			add_location(section, file, 30, 2, 783);
    			...
    			add_location(img3, file, 42, 4, 1269);
    			attr_dev(h1, "class", "text-center");
    			set_style(h1, "font-size", "50px");
    			add_location(h1, file, 44, 5, 1391);
    			attr_dev(h2, "class", "text-center");
    			set_style(h2, "font-size", "35px");
    			add_location(h2, file, 45, 5, 1456);
    			attr_dev(div0, "class", "text-cyan-700");
    			add_location(div0, file, 43, 4, 1358);
    			add_location(div1, file, 41, 3, 1259);
    			attr_dev(div2, "class", "font-9xl flex flex-wrap justify-center my-8");
    			add_location(div2, file, 40, 2, 1198);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(30:1) <Visibility steps={100} let:percent let:unobserve let:intersectionObserverSupport>",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 28, 0, 690);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
